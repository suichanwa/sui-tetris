(function(){
	...
	let updateScore=function(){
		context.font="bold 1px Hack";
		context.fillStyle="#ffffff";
		context.textAlign="left";
		context.textBaseline="top";
		context.fillText("スコア : "+player.score,0.2,0);
	};

	let gameOver = function(){
		clearInterval(gameLoop);
		context.font="1px Hack";
		context.fillStyle="#ffffff";
		context.textAlign="center";
		context.textBaseline="middle";
		context.fillText("ゲームオーバー ",(canvas.width/20)/2,(canvas.width/20)/2);
		document.getElementById("start_game").disabled=false;
	};

    //images
    //also all images all in the iamges folder

	const colors = [
		null,
		"https://i.postimg.cc/cJdKfKx0/1.jpg",
        //1 image
		"https://i.postimg.cc/9fHdKFcn/2.jpg",
		//2 image
        "https://i.postimg.cc/XNBwjCXz/3.png",
		//3 image
        "https://i.postimg.cc/rpGYD4Dc/Screenshot-from-2022-03-22-15-16-01.png",
		//4 image
        "https://i.postimg.cc/5yPcKRvs/5.jpg",
		//5 image
        "https://i.postimg.cc/3R7P8TFL/6.png",
		//6 image
        "https://i.postimg.cc/tCfw1Pzn/7.png"
        //7 image
    ];
	...
	document.addEventListener('keydown',function(e){
        ...
        //for future for vim keywords work or phones
        else if(e.keyCode===1){
            playerMove(-move);
        }
